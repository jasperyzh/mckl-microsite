...
import Vue from 'vue';
import AccaNews from './vue/AccaNews.vue';
if (document.getElementById("AccaNews")) {
    new Vue({ render: createElement => createElement(AccaNews) }).$mount('#AccaNews');
}
