<template>
  <form id="gform-mckl" class="col" method="POST" action="./thank-you">
    ...
    >
      <option value="ACCAFIA">ACCA Foundation in Accountancy (ACCA FIA)</option>
      <option value="ACCA-Full">
        Association of Chartered Certified Accountants (ACCA) – Full Time
      </option>
      <option value="ACCA-Part">
   ...
   -->
    ...
    <div id="ga-form_programme" class="form-group">
      ...
      <!-- <p class="mx-2 my-1">*German Pathway available</p> -->
    </div>
    ...
    <button
      type="submit"
      class="btn btn-primary btn-primary-mckl"
